...
Property_Activity: {
  ...
  SponsorAccounts: {
    __id: RECORD_FIELD,
    Sponsor_Account: { id: "Sponsor_Account", real: "Sponsor Account", fieldId: "fldzfCG1xhP2g2qzEZf", type: "text", camel: "sponsorAccount" },
    Business_Name: { id: "Business_Name", real: "Business Name", fieldId: "fldNcR0CRSuydsrknFJ", type: "text", camel: "businessName" },
    Business_Adverts: { id: "Business_Adverts", real: "Business Adverts", fieldId: "fldRG750QkZ3D0aT1ui", type: "link", camel: "businessAdverts" },
    Contact_Name: { id: "Contact_Name", real: "Contact Name", fieldId: "flduN0073uV6HPUWbbo", type: "text", camel: "contactName" },
    Contact_Phone: { id: "Contact_Phone", real: "Contact Phone", fieldId: "fldKMX3YTbrVCdlR6FY", type: "text", camel: "contactPhone" },
    Business_Address: { id: "Business_Address", real: "Business Address", fieldId: "fldADWBymhw8DcxPWdI", type: "longText", camel: "businessAddress" },
    Email: { id: "Email", real: "Email", fieldId: "fldNyywXsD8SIRL6EQY", type: "text", camel: "email" },
    Website: { id: "Website", real: "Website", fieldId: "fldZrDyGlELTegwfrtg", type: "text", camel: "website" },
    User_ID: { id: "User_ID", real: "User ID", fieldId: "fld2cYiqfztClGf4aHr", type: "text", camel: "userId" },
    Status: { id: "Status", real: "Status", fieldId: "fldkZsaYdyygEXsXE1r", type: "singleSelect", camel: "status" },
    Stripe_Customer_ID: { id: "Stripe_Customer_ID", real: "Stripe Customer ID", fieldId: "fldeee8HlB7Ekjvn6PR", type: "text", camel: "stripeCustomerId" },
    Created: { id: "Created", real: "Created", fieldId: "fld1foua8bydDlx8bjq", type: "createdTime" },
    Updated: { id: "Updated", real: "Last Updated", fieldId: "fldym68BqSZkEBiN5oN", type: "lastModifiedTime" },
  },

  BusinessAdverts: {
    __id: RECORD_FIELD,
    Advert: { id: "Advert", real: "Advert", fieldId: "fldDCW2JQrGscG4Whj5", type: "text", camel: "advert" },
    Sponsor_Account: { id: "Sponsor_Account", real: "Sponsor Account", fieldId: "fldQ8JmIR4xAid8DHAW", type: "link", camel: "sponsorAccount" },
    Advertiser: { id: "Advertiser", real: "Advertiser", fieldId: "fldDfwGJ8pUITgFZbuC", type: "link", camel: "advertiser" },
    Business_Name: { id: "Business_Name", real: "Business Name", fieldId: "fldgRPamyHfZE1aE0qT", type: "text", camel: "businessName" },
    Creative: { id: "Creative", real: "Creative", fieldId: "fldPMEtE6evTyV01UfW", type: "attachment", camel: "creative" },
    Alt_Text_EN: { id: "Alt_Text_EN", real: "Alt Text EN", fieldId: "fldyd9tltLxbGHLNw4o", type: "text", camel: "altTextEn" },
    Alt_Text_ES: { id: "Alt_Text_ES", real: "Alt Text ES", fieldId: "fldHE92p2ojBLAatryK", type: "text", camel: "altTextEs" },
    Destination_URL: { id: "Destination_URL", real: "Destination URL", fieldId: "fld980OwJh6lUj00iP6", type: "text", camel: "destinationUrl" },
    Offer: { id: "Offer", real: "Offer", fieldId: "fldgSxURenzmM6nJ5ON", type: "longText", camel: "offer" },
    Billing_Status: { id: "Billing_Status", real: "Billing Status", fieldId: "fld0BaIJooXRjJMs6V4", type: "singleSelect", camel: "billingStatus" },
    Monthly_Amount_MXN: { id: "Monthly_Amount_MXN", real: "Monthly Amount MXN", fieldId: "fldHN6F9SjyATto2sho", type: "number", camel: "monthlyAmountMxn" },
    Approved: { id: "Approved", real: "Approved", fieldId: "fldNeContVStWLi293f", type: "checkbox", camel: "approved" },
    Status: { id: "Status", real: "Status", fieldId: "fld4iiBjupxrV0c8mA6", type: "singleSelect", camel: "status" },
    Sponsor_Tier: { id: "Sponsor_Tier", real: "Sponsor Tier", fieldId: "fld461NDEFUBMsyHdzU", type: "singleSelect", camel: "sponsorTier" },
    Placement: { id: "Placement", real: "Placement", fieldId: "fldqpCHuHLHUJLU7lCQ", type: "singleSelect", camel: "placement" },
    Display_Placement: { id: "Display_Placement", real: "Display Placement", fieldId: "fldPWcrKPA0NmAlR51u", type: "singleSelect", camel: "displayPlacement" },
    Priority: { id: "Priority", real: "Priority", fieldId: "fldfEdilBIDw5zN4D3n", type: "number", camel: "priority" },
    Audience: { id: "Audience", real: "Audience", fieldId: "fldB1DamXe5a6kFU4VZ", type: "singleSelect", camel: "audience" },
    Start_Date: { id: "Start_Date", real: "Start Date", fieldId: "fldufP2lKjQUMXHUy33", type: "date", camel: "startDate" },
    End_Date: { id: "End_Date", real: "End Date", fieldId: "fldo591TVTBJRGJ7Ytt", type: "date", camel: "endDate" },
    Stripe_Checkout_Session_ID: { id: "Stripe_Checkout_Session_ID", real: "Stripe Checkout Session ID", fieldId: "fld6iGn8SPT75SHXIv3", type: "text", camel: "stripeCheckoutSessionId" },
    Stripe_Subscription_ID: { id: "Stripe_Subscription_ID", real: "Stripe Subscription ID", fieldId: "fldU615LfPxXHbIRu8F", type: "text", camel: "stripeSubscriptionId" },
    Stripe_Customer_ID: { id: "Stripe_Customer_ID", real: "Stripe Customer ID", fieldId: "fld0J0sc75jzcY2jjT6", type: "text", camel: "stripeCustomerId" },
    Current_Period_End: { id: "Current_Period_End", real: "Current Period End", fieldId: "fldONau3wFQaQZ8a5zj", type: "date", camel: "currentPeriodEnd" },
    Cancellation_At: { id: "Cancellation_At", real: "Cancellation At", fieldId: "fldsPVaL1MCGOZIhPKk", type: "date", camel: "cancellationAt" },
    Coupon_Code: { id: "Coupon_Code", real: "Coupon Code", fieldId: "fldYsqd7gTuggnr2Dtt", type: "text", camel: "couponCode" },
    Created: { id: "Created", real: "Created", fieldId: "fld6yYPhegNIt0LmcmR", type: "createdTime" },
  },
};
