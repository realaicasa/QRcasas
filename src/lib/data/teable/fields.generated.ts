...
export const FIELDS: Record<string, Record<string, FieldMeta>> = {
  ...
  Properties: {
    ...
    Listing_Start_Date: { id: "Listing_Start_Date", real: "Listing Start Date", fieldId: "fldyYNd5PSAP9MjyzMX", type: "date", camel: "listingStartDate" },
    Listing_Expiry_Date: { id: "Listing_Expiry_Date", real: "Listing Expiry Date", fieldId: "fldNDSf8Thxhg0ZQH1Z", type: "date", camel: "listingExpiryDate" },
    Reminder_Sent_At: { id: "Reminder_Sent_At", real: "Reminder Sent At", fieldId: "fldfAUwsCsoDZT81jec", type: "date", camel: "reminderSentAt" },
    Archive_Until_Date: { id: "Archive_Until_Date", real: "Archive Until Date", fieldId: "fldCgQgc6UMJ2q9XPFW", type: "date", camel: "archiveUntilDate" },
    Lifecycle_State: { id: "Lifecycle_State", real: "Lifecycle State", fieldId: "fldiszxPT1VLcIYKdTp", type: "singleSelect", camel: "lifecycleState" },
